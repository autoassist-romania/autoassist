    ...
    try {
      ...
      if(code) {
        ...
        if(!error && data?.session?.user) {
          ...
          _applySection((()=>{const s=localStorage.getItem('aa_last_sec');const v=['dashboard','garaj','documente','rca','rovinieta','agenti','vocal','asistenta','mentenanta','anvelope','ev','vanzare','carvertical','legal','setari','docpers'];return(s&&v.includes(s))?s:'dashboard';})());
          dismissOverlay();
          return;
        }
      }
