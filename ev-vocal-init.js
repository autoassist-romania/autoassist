  ...
  setTimeout(function(){
    ...
    if(!document.querySelector('.sec.active')) {
      if(currentUser) {
        ...
        const validSections = ['dashboard','garaj','documente','rca','rovinieta','agenti','vocal','asistenta','mentenanta','anvelope','ev','vanzare','carvertical','legal','setari','docpersonale','servicii-stat','itp','costuri','verificare','peco','verif-nr','asistenta','premium'];
    ...
    try {
      ...
      if(code) {
        ...
        if(!error && data?.session?.user) {
          ...
          _applySection((()=>{const s=localStorage.getItem('aa_last_sec');const v=['dashboard','garaj','documente','rca','rovinieta','agenti','vocal','asistenta','mentenanta','anvelope','ev','vanzare','carvertical','legal','setari','docpersonale','servicii-stat','itp','costuri','verificare','peco','verif-nr','asistenta','premium'];return(s&&v.includes(s))?s:'dashboard';})());
          dismissOverlay();
          return;
        }
      }
