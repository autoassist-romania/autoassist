...
function pieseCopiazaVin(vin) {
  navigator.clipboard.writeText(vin).then(() => {
    showNotification('📋 VIN copiat!', `Lipește-l în căsuța de căutare VIN de pe site-ul magazinului (AutoDoc/AutoEco) — nu îl putem completa noi automat, e un widget al lor.`);
  }).catch(() => {
