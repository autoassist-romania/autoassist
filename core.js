...
function _applySection(sec){
  ...
  } else if(sec === 'servicii-stat' || sec === 'masina') {
  ...
  if(sec==='vanzare'){loadVanzCars();vanzLoadLista();if(!selCarId){document.getElementById('vanz-step1').style.display='block';document.getElementById('vanz-step2').style.display='none';document.getElementById('vanz-step3').style.display='none';}}
  renderAll(); 
