...
async function sendMsg(){
  ...
  msgs.innerHTML+=`<div class="msg ai" id="${tid}"><div class="mav ai">AA</div><div class="mb"><div class="mn">${AGENT_NAMES[curAgent]}</div><div class="mbu"><span style="display:inline-flex;gap:4px"><span style="width:7px;height:7px;border-radius:50%;background:var(--t3);animation:bounce 1.1s infinite"></span><span style="width:7px;height:7px;border-radius:50%;background:var(--t3);animation:bounce 1.1s .18s infinite"></span><span style="width:7px;height:7px;border-radius:50%;background:var(--t3);animation:bounce 1.1s .36s infinite"></span></span></div></div></div>`;
  msgs.scrollTop=msgs.scrollHeight;
